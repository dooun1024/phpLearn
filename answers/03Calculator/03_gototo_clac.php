...
<form>
    <table id="calc">
        <tr>
            <div><p><?php echo $resule . "<br>"; ?></p></div>
        </tr>
        <tr>
            <td>
                <div>
                    <button name="figure" value="1">1</button>
                </div>
            </td>
            <td>
                <div>
                    <button name="figure" value="2">2</button>
                </div>
            </td>
            <td>
                <div>
                    <button name="figure" value="3">3</button>
                </div>
            </td>
            <td>
                <div>
                    <button name="mark" value="plus">＋</button>
                </div>
            </td>
        </tr>
        <tr>
            <td>
                <div>
                    <button name="figure" value="4">4</button>
                </div>
            </td>
            <td>
                <div>
                    <button name="figure" value="5">5</button>
                </div>
            </td>
            <td>
                <div>
                    <button name="figure" value="6">6</button>
                </div>
            </td>
            <td>
                <div>
                    <button name="mark" value="minus">－</button>
                </div>
            </td>
        </tr>
        <tr>
            <td>
                <div>
                    <button name="figure" value="7">7</button>
                </div>
            </td>
            <td>
                <div>
                    <button name="figure" value="8">8</button>
                </div>
            </td>
            <td>
                <div>
                    <button name="figure" value="9">9</button>
                </div>
            </td>
            <td>
                <div>
                    <button name="mark" value="multi">×</button>
                </div>
            </td>
        </tr>
        <tr>
            <td>
                <div>
                    <button name="figure" value="0">0</button>
                </div>
            </td>
            <td>
                <div>
                    <button name="figure" value=".">.</button>
                </div>
            </td>
            <td>
                <div>
                    <button name="clear" value="clear">C</button>
                </div>
            </td>
            <td>
                <div>
                    <button name="mark" value="divi">÷</button>
                </div>
            </td>
        </tr>
        <tr>
            <td>
                <div>
                    <button name="equal" value="equal">=</button>
                </div>
            </td>
            <td>
                <div>
                    <button name="other" value="mai">±</button>
                </div>
            </td>
            <td>
                <div>
                    <button name="other" value="back">←</button>
                </div>
            </td>
            <td>
                <div>
                    <button><a href="https://yukainaotakus.dooun.net">㊙︎</a></button>
                </div>
            </td>
        </tr>
    </table>
